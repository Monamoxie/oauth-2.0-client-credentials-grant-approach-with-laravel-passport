            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-8 text-2xl">
                        Welcome to your Resource Dashboard. You are a client here. </b>
                    </div>
                    ...
                    <div class="mt-6 text-gray-500">
                        ...
                        @if(count($posts) < 1) 
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                <strong class="font-bold">You do not have any resource posts yet you can access from your client server</strong> <br/> <br/>
                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="bg-green-100 border border-green-400 text-green-700 px-3 py-3 rounded relative uppercase mt-4" role="alert">
